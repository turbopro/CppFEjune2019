	...
	namespace Containers
	{
		...
		ShapeType& choose_shape()
		{
			...
			case 'c':
			{
				...
				if (user_input_geom(x, "Circle", "CentrePoint: x_coordinate") &&
					user_input_geom(y, "Circle", "CentrePoint: y_coordinate") &&
			...
			case 'l':
			{
				...
				if (user_input_geom(s_x, "Line", "StartPoint: x_coordinate") &&
					user_input_geom(s_y, "Line", "StartPoint: y_coordinate") &&
					user_input_geom(e_x, "Line", "EndPoint: x_coordinate") &&
					user_input_geom(e_y, "Line", "EndPoint: y_coordinate"))
				{
			...
			case 'p':
			{
				...
				double x{ 0.0 }, y{ 0.0 };
				if (user_input_geom(x, "Point", "x_coordinate") &&
					user_input_geom(y, "Point", "y_coordinate"))
				{
					Point p0(x, y);
					chosen = p0;
				}
		...
		// Variantvisitor class: moves the Shapes 
